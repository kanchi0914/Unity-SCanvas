...
namespace SGUI.GameObjects
{
    class SDropDown : SGameObject
    {
        ...
        public SDropDown AddOption(string text, Action action)
        {
        ...
        {
            var action = options[dropdown.value].action;
        ...
        public new SDropDown SetBackGroundColor(ColorType colorType, float alpha = 1)
        {
            return base.SetBackGroundColor(colorType, alpha) as SDropDown;
        }

        public new SDropDown SetBackGroundColor(Color color)
        {
            return base.SetBackGroundColor(color) as SDropDown;
        }

        public new SDropDown SetParentSGameObject(SGameObject parent)
        {
            return base.SetParentSGameObject(parent) as SDropDown;
        }

        public new SDropDown SetRectSize(float width, float height)
        {
            return base.SetRectSize(width, height) as SDropDown;
        }

        public new SDropDown SetRectSizeByRatio(float ratioX, float ratioY)
        {
            return base.SetRectSizeByRatio(ratioX, ratioY) as SDropDown;
        }

        public new SDropDown SetLocalPos(float width, float height)
        {
            return base.SetLocalPos(width, height) as SDropDown;
        }

        public new SDropDown SetLocalPosByRatio(float posXratio, float posYratio)
        {
            return base.SetLocalPosByRatio(posXratio, posYratio) as SDropDown;
        }

        public new SDropDown SetAnchorType(AnchorType anchorType)
        {
            return base.SetAnchorType(anchorType) as SDropDown;
        }
