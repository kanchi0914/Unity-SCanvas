...
// {
//     public class SDOTextMessageWindow : EGGameObject
//     {
...
//         }
//
//         public void SetMessage(string message, Action action)
//         {
//             this.messageQueue = new Queue<(string message, Action action)>();
//             messageQueue.Enqueue((message, action));
//             ShowNextMessage();
//         }
//
...
//         }
//
//         public new SDOTextMessageWindow SetParentSGameObject(EGGameObject parent)
//         {
