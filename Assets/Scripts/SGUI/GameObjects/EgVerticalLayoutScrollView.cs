...
{
    class EgVerticalLayoutScrollView : EGGameObject, ILayoutObject
    {
        ...
        public EgVerticalLayoutScrollView SetPadding(int? left = null, int? right = null, int? top = null, int? bottom = null)
        {
