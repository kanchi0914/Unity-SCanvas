...
namespace Assets.Scripts.Examples.AdvGame
{
    public class GUIData
    {
        ...
        public static EGText.TextPreset MessageWindowText = new EGText.TextPreset(GenjuGothicBold, color: Color.white, fontSize:20);
        public static EGText.TextPreset OptionText = new EGText.TextPreset(GenjuGothicBold, color: Color.white, 
            resizeTextForBestFit:true, resizeTextMaxSize:24, resizeTextMinSize:10);
