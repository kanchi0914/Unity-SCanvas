...
namespace Assets.Scripts.Examples.AdvGame
{
    public class Scenario4_AfternoonDote : Scenario
    {
        ...
        {
            Renderer.SetBackgroundImage("bg_dote_yuyake");
        }
        ...
        protected override void InitScripts()
        {
            var intro = new List<Section>()
            {
                ...
                new Section("ヒロ子", "‥‥‥‥‥", () => Renderer.SetCharacterImage("ヒロ子", "smile")),
                ...
                new Section("ヒロ子", "うん\n‥‥‥ヒロシくんとの結婚資金", 
                    () => Renderer.SetCharacterImage("ヒロ子", "tere")),
                new Section("ヒロシ", "‥‥‥‥は？"),
                new Section("ヒロ子", "ヒロシくん！！好きです　わたしと付き合ってください！！！", 
                    () =>
                    {
                        Renderer.SetCharacterImage("ヒロ子", "love");
                        var option1 = new Option($"{ScenarioName}_say_yes", "はい", () => LoadScript("say_yes"));
                        var option2 = new Option($"{ScenarioName}_say_no", "いいえ", () => LoadScript("say_no"));
                        Renderer.ShowOptionsWindow(option1, option2);
                    }),
            };
