...
namespace Assets.Scripts.Examples.AdvGame
{
    public class Scenario4_Afternoon : Scenario
    {
        ...
        {
            Renderer.SetBackgroundImage("bg_school_room_yuyake");
        }
        ...
        protected override void InitScripts()
        {
            ...
            {
                new Section("", "　～放課後～"),
                new Section("ヒロ子", "ねーもういいでしょ　ヒロシくん\n犯人教えてよ", () => Renderer.SetCharacterImage("ヒロ子", "normal")),
                new Section("ヒロシ", "わかったよ　それじゃ言うぞ\n犯人は‥‥", () =>
                {
                    var option1 = new Option($"{ScenarioName}_choose_hiroko", "ヒロ子だ",
                        () => LoadScript("choose_hiroko"));
                    var option2 = new Option($"{ScenarioName}_choose_myself", "俺だ",
                        () => LoadScript("choose_myself"));
                    var option3 = new Option($"{ScenarioName}_choose_saito", "斎藤さん自身だ",
                        () => LoadScript("choose_saito"));
                    var option4 = new Option($"{ScenarioName}_choose_cat", "猫だ",
            ...
            var choose_hiroko = new List<Section>()
            {
                ...
                new Section("ヒロ子", "えっ！？", () => Renderer.SetCharacterImage("ヒロ子", "running")),
            ...
            var choose_cat = new List<Section>()
            {
                ...
                new Section("ヒロ子", "ふむふむ", () => Renderer.SetCharacterImage("ヒロ子", "normal")),
